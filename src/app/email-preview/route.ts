...
// ⬇️ cole aqui as mesmas funções do teu route.ts
            ...
            <td style="background:${C.green};padding:18px 22px;color:#ffffff;">
              <div style="font-size:16px;line-height:22px;">
                <div style="margin-bottom:10px;">
                  Olá, <b>${escapeHtml(nomeJovem)}</b> 👋<br/>
...
export async function GET() {
  // payload fake só pra preview
  const payload = {
    nome: "Emanuel João Teste",
    apelido: "Emanuel",
    nascimento: "2005-08-12",
    whatsapp: "51999999999",
    email: "teste@exemplo.com",
    rua: "Av. Antônio de Conto",
    numero: "449",
    bairro: "Centro",
    cidade: "Encantado/RS",
    macro: "Macrorregião Sul",
    ger: "GER SUL 3 RS 1",
    ged: "GED SANTA CRUZ DO SUL",
    servicoMcc: "Representante Jovem",
    camiseta: "M",
    alergiaTem: "Não tenho!",
    alergiaDesc: "",
    restricaoTem: "Tenho!",
    restricaoDesc: "Sem lactose",
  };

  return new NextResponse(buildEmailHtml(payload), {
